...
public class livepage extends Activity {
    ...
    private String mStreamKey = "rtmp://39.106.182.248:94/live/123";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button live_returnbt = (Button) findViewById(R.id.live_returnbt);
        live_returnbt.setOnClickListener(new Button.OnClickListener() {			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent();
				intent.setClass(livepage.this, teacherpage.class);
        ...
        mUIEventHandler = new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                case UI_EVENT_SHOW_STREAMING_ACTIVITY:
                    Intent intent = new Intent(livepage.this, StreamingActivity.class);
                    saveStreamParams();
                ...
                case UI_EVENT_HINT_NO_STREAMING_URL:
                    ...
                    Toast.makeText(livepage.this, "未获取到有效的推流地址，已使用上次推流的地址！", Toast.LENGTH_SHORT).show();
