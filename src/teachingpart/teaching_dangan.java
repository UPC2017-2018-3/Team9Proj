...
public class teaching_dangan extends Activity implements IReflashListener,ILoadListener{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		fanhuibt.setOnClickListener(new Button.OnClickListener() {			
			...
			public void onClick(View v) {
				...
				intent.setClass(teaching_dangan.this, teachingpage.class);
		...
		listview.setOnItemClickListener(new OnItemClickListener(){  
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				Intent intent = new Intent(teaching_dangan.this,teaching_student_zhuwang.class);  
	            startActivity(intent);  
			}                                 
	    });
	...
	private void setReflashData() {
		for (int i = 0; i < 2; i++) {
			ApkEntity entity = new ApkEntity();
			entity.setstudent_marklv_t1("《AE基础操作入门》");
	...
	private void getLoadData() {
		for (int i = 0; i < 2; i++) {
			ApkEntity entity = new ApkEntity();
			entity.setstudent_marklv_t1("《PS基础操作入门》");
			apk_list.add(entity);
		}
	}
	@Override
