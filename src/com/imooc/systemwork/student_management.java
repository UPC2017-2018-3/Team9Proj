...
public class student_management extends Activity implements IReflashListener,ILoadListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button fanhuibt = (Button) findViewById(R.id.student_returnbt);
		...
		fanhuibt.setOnClickListener(new Button.OnClickListener() {			
			...
			public void onClick(View v) {
				...
				intent.setClass(student_management.this, teachingpage.class);
	...
	private void showList(ArrayList<ApkEntity> apk_list) {
		if (adapter == null) {
			listview = (ReFlashListView) findViewById(R.id.student_listview);
			listview.setInterface(this);
			listview.setInterfoot(this);
			adapter = new studentAdapter(this, apk_list);
	...
	private void setData() {
		...
		for (int i = 0; i < lgroup.size(); i++) {
			...
			entity.setstudent_t1(lgroup.get(i).studentname);
			apk_list.add(entity);
		}
	}
