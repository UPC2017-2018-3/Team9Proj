...
public class course_management extends Activity implements IReflashListener,ILoadListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button fanhuibt = (Button) findViewById(R.id.course_returnbt);
		setData();
		showList(apk_list);
		fanhuibt.setOnClickListener(new Button.OnClickListener() {			
			...
			public void onClick(View v) {
				...
				intent.setClass(course_management.this, teachingpage.class);
	...
	private void showList(ArrayList<ApkEntity> apk_list) {
		if (adapter == null) {
			listview = (ReFlashListView) findViewById(R.id.course_listview);
	...
	private void setData() {
		...
		for (int i = 0; i <  lgroup.size(); i++) {
			...
			entity.setcourse_t1(lgroup.get(i).coursename);
			apk_list.add(entity);
		}
	}
