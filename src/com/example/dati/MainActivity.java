...
import com.example.student.zixun_yuanxiaoActivity;
import com.example.student.zixunxiangqingActivity;
...
public class MainActivity extends FragmentActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.datizhuye);
		loadData();
	...
	public void onClick(View v) {
		...
		case R.id.tv_back://点击头部返回
            ...
            intent.setClass(MainActivity.this, student_MainActivity.class);    
		...
		case R.id.tv_time://点击头部计时器
			//TODO计时器停止计时
			stopCounter();
			 final ConfirmDialog confirmDialog = new ConfirmDialog(this, "共5道题，还剩5道题未做");
	...
	private void loadData() {
		...
		for (int i = 1; i < lgroup.size()+1; i++) {
			
	    List<QuestionOptionBean> ceshi = new ArrayList<QuestionOptionBean>();
		// 初始化数据
		...
		option = new QuestionOptionBean("D",
				lgroup.get(i-1).D);
		ceshi.add(option);
		question = new QuestionBean("000"+i, lgroup.get(i-1).question, 1, "常识判断",
				"001", ceshi);
		questionlist.add(question);
