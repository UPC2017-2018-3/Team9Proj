...
public class MyAdapter1 extends BaseAdapter {
	...
	public MyAdapter1(List<Payment> List, Context context, ChangeTextView changeTextView) {
		this.mList = List;
	...
	private class MyOnEvenClick implements MyItemClicked {
		...
		public void myItemClicked() {
			String strParams = "organization:" + ApkEntity.getorganization();	
			...
			Intent intent = new Intent(mContext, kecheng_MainActivity.class);
