...
public class zixun_student_lvActivity extends Activity{
...
//						 theme, Toast.LENGTH_LONG).show();
                ...
                intent.setClass(zixun_student_lvActivity.this, zixunxiangqingActivity.class);    
		 ...
		 zixun_backw.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					Intent intent = new Intent();  
	                intent.setClass(zixun_student_lvActivity.this, student_MainActivity.class);
	                startActivity(intent);
				}
			});        
