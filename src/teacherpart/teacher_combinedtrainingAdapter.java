...
public class teacher_combinedtrainingAdapter extends BaseAdapter{
	ArrayList<ApkEntity> apk_list;
	LayoutInflater inflater;
	protected Context context;

	public teacher_combinedtrainingAdapter(Context context, ArrayList<ApkEntity> apk_list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = inflater.inflate(R.layout.teacher_combinedtraininglv, null);
			holder.teacher_combinedtraininglvt1 = (TextView) convertView
					.findViewById(R.id.teacher_combinedtraininglvt1);
			holder.teacher_combinedtraininglvb1 = (Button) convertView
					.findViewById(R.id.teacher_combinedtraininglvb1);
			convertView.setTag(holder);
		}else{
			holder = (ViewHolder) convertView.getTag();
		}
		holder.teacher_combinedtraininglvt1.setText(entity.getteacher_combinedtraininglv());
		holder.teacher_combinedtraininglvb1.setOnClickListener(new ListOnClick(position));
	...
	class ViewHolder {
		TextView teacher_combinedtraininglvt1;
		Button teacher_combinedtraininglvb1;
	...
	class ListOnClick implements OnClickListener{
		...
		public void onClick(DialogInterface dialog, int which) {
			...
			teacher_combinedtrainingAdapter.this.notifyDataSetChanged(); //记得调用它
			String account = ApkEntity.getaccount();
			 String coursename = ApkEntity.getcoursename();
				...
				String retString=Bydeleteexercise.LogSelect(str);
