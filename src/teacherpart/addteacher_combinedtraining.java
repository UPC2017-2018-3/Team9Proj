...
public class addteacher_combinedtraining extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		checkedTextView2.setOnClickListener(new Button.OnClickListener() {			
			...
			public void onClick(View v) {
				...
				((ApkEntity) getApplication()).setab(flag2);
			}
		});
		checkedTextView3.setOnClickListener(new Button.OnClickListener() {			
			...
			public void onClick(View v) {
				...
				((ApkEntity) getApplication()).setac(flag3);
			}
		});
		checkedTextView4.setOnClickListener(new Button.OnClickListener() {			
			...
			public void onClick(View v) {
				...
				((ApkEntity) getApplication()).setad(flag4);
			}
		});
		...
		rt.setOnClickListener(new Button.OnClickListener() {			
			...
			public void onClick(View v) {
				...
				intent.setClass(addteacher_combinedtraining.this, teacherpart.teacher_combinedtraining.class);
		...
		tj.setOnClickListener(new Button.OnClickListener() {			
			...
			public void onClick(View v) {
				...
				String retString=Bycreateexercises.LogSelect(strParams);
