...
import com.imooc.systemwork.studentAdapter;
...
public class teacher_coursemanagementrbAdapter extends BaseAdapter{
	ArrayList<ApkEntity> apk_list;
	LayoutInflater inflater;
	protected Context context;

	public teacher_coursemanagementrbAdapter(Context context, ArrayList<ApkEntity> apk_list) {
